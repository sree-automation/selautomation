...
public class ErrorValidations extends BaseTest{
	...
	@Test
	public void LoginErrorValidation1() throws IOException, InterruptedException
	{
		landingPage.loginToApplication("sreenath.msc@gmail.com", "password");
	...
	{
		landingPage.loginToApplication("sreenath.msc@gmail.com", "Vinnu@828");
		Assert.assertEquals("Incorrect email or password.", landingPage.getErrorMessage());
	}*/
